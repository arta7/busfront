...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <ContactUsTitle variant="h1" className={i18n.language === 'fa' ? 'rtl-text' : ''}>
        {t('contact.title')}
      </ContactUsTitle>
        ...
        {contactMethods.map((method, index) => (
          <Grid item xs={12} md={4} key={index}>
            <ContactCard>
              <CardContent>
                <ContactIcon src={method.icon} alt={method.title} style={method.iconSize} />
                <ContactMethodTitle variant="h4" fontWeight="600" className={i18n.language === 'fa' ? 'rtl-text' : ''}>
                  {method.title}
                </ContactMethodTitle>
                ...
                {method.details.map((detail, i) => (
                  detail.isLink ? (
                    <ContactLink 
                      ...
                      mt={4}
                      underline="hover"
                      className={i18n.language === 'fa' ? 'rtl-text' : ''}
                    >
                      {detail.label}
                    </ContactLink>
                  ) : typeof detail === 'string' ? (
